...
namespace SZHelperCore
{
    ...
    public class Chinese2Spell
    {
        ...
        /// 取拼音第一个字段
        /// </summary>
        public static String GetHeadOfChs(String str)
        {
        ...
        /// 把汉字转换成拼音(全拼)
        /// </summary>
        private static String ChsString2Spell(String str)
        {
            if (String.IsNullOrEmpty(str)) return String.Empty;
        ...
        public static string GetSearchStr(string value)
        {
            if (String.IsNullOrEmpty(value)) return String.Empty;

            var sb = value.ToCharArray();
            string chs = "";
            string chsHead = "";
            ...
            for (var j = 0; j < sb.Length; j++)
            {
                ...
                if (!String.IsNullOrEmpty(chsStr))
                {
                    chsHead = chsHead + chsStr.Substring(0, 1);
                }
            }
